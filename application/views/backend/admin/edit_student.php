								...
								foreach($classes as $key => $class):
									?>
                                        <option value="<?php echo $class['class_id'];?>"
                                            <?php if($student['class_id'] == $class['class_id']) echo 'selected';?>>
                                            <?php echo $class['name'];?>
                                        </option>
                                        <?php
								endforeach;
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <select name="tran_cert" class="form-control select2" style="width:100%">
                                        ...
                                        <option value="Yes" <?php if($student['tran_cert']== 'Yes') echo 'selected';?>>
                                            Yes</option>
                                        <option value="No" <?php if($student['tran_cert']== 'No') echo 'selected';?>>No
                                        </option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <select name="dob_cert" class="form-control select2" style="width:100%">
                                        ...
                                        <option value="Yes" <?php if($student['dob_cert']== 'Yes') echo 'selected';?>>
                                            Yes</option>
                                        <option value="No" <?php if($student['dob_cert']== 'No') echo 'selected';?>>No
                                        </option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <select name="physical_h" class="form-control select2" style="width:100%">
                                        ...
                                        <option value="Yes" <?php if($student['physical_h']== 'Yes') echo 'selected';?>>
                                            Yes</option>
                                        <option value="No" <?php if($student['physical_h']== 'No') echo 'selected';?>>No
                                        </option>
                                    </select>
                                </div>
                            </div>
