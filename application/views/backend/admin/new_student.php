                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="date" value="2011-08-19" id="example-date-input"
                                        class="form-control datepicker" name="date_of_leaving">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
	                              ...
	                              ?>
                                        <option value="<?php echo $row['dormitory_id'];?>"><?php echo $row['name'];?>
                                        </option>
                                        <?php endforeach;?>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
	                              ...
	                              ?>
                                        <option value="<?php echo $row['transport_id'];?>"><?php echo $row['name'];?>
                                        </option>
                                        <?php endforeach;?>
                                    </select>
